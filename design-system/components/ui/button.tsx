...
const buttonVariants = cva(
  "inline-flex items-center justify-center whitespace-nowrap rounded-full text-sm font-medium ring-offset-background transition-all duration-150 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 active:scale-[0.98]",
  {
    variants: {
      variant: {
        default:
          "bg-primary text-primary-foreground hover:bg-primary/90 hover:shadow-md active:bg-primary/95",
        destructive:
          "bg-destructive text-destructive-foreground hover:bg-destructive/90 hover:shadow-md active:bg-destructive/95",
        outline:
          "border border-teal-dark bg-background text-teal-dark hover:bg-teal-dark/10 hover:shadow-sm active:bg-teal-dark/15",
        "outline-white":
          "border border-stone-500 bg-transparent text-foreground hover:bg-stone-500/10 hover:shadow-sm active:bg-stone-500/15",
        secondary:
