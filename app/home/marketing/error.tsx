  ...
  return (
    <div className="flex min-h-screen items-center justify-center p-4 lg:pl-36">
      <CardWrapper className="max-w-md p-8 text-center">
        ...
        <h2 className="mb-2 text-lg font-semibold text-gray-900">Unable to load marketing</h2>
        <p className="mb-6 text-sm text-gray-600">
          We encountered an error while loading your marketing data. This might be a temporary
          issue.
        </p>
