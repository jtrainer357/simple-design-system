  ...
  return (
    <div className={cn("space-y-3", className)}>
      <div className="flex items-center justify-between">
        ...
        <Select
          value={currentStatus}
          onValueChange={(val) => handleStatusSelect(val as PatientStatus)}
        >
        ...
        <AlertDialogContent>
          <AlertDialogHeader>
            <AlertDialogTitle className="flex items-center gap-2">
              {isDischarging && <AlertTriangle className="text-warning h-5 w-5" />}
            ...
            <AlertDialogDescription asChild>
              <div className="space-y-4">
                ...
                {isDischarging && (
                  <div className="bg-warning/10 text-warning-foreground rounded-md p-3">
          ...
          <AlertDialogFooter>
            ...
            <AlertDialogAction
              ...
              className={cn(
                "min-h-[44px]",
                isDischarging && "bg-warning text-warning-foreground hover:bg-warning/90"
              )}
            >
