      ...
      >
        <DialogHeader>
          ...
          <DialogDescription className="text-center">
            ...
            <span className="text-foreground font-bold">{formatCountdown(countdown)}</span>.
            <br />
        ...
        <DialogFooter className="flex-col gap-2 sm:flex-row">
          <Button variant="outline" onClick={handleLogout} className="h-12 w-full sm:w-auto">
            <LogOut className="mr-2 h-4 w-4" />
            Log Out
          </Button>
          <Button onClick={handleContinueSession} className="h-12 w-full sm:w-auto">
            Continue Session
          </Button>
        </DialogFooter>
      </DialogContent>
