...
const actionColors: Record<ActionType, string> = {
  message: "text-teal bg-teal/20",
  order: "text-teal bg-teal/20",
  medication: "text-teal bg-teal/20",
  task: "text-teal bg-teal/20",
  document: "text-teal bg-teal/20",
};
...
export function SuggestedActionsSection({
  ...
  return (
    <div className={cn("space-y-3", className)}>
      ...
      <div className="border-teal/40 bg-teal/10 rounded-lg border-2 border-dashed p-3">
              ...
              >
                <label
                  className={cn(
                    ...
                    "hover:border-teal/60 transition-all hover:shadow-sm",
                    disabled && "cursor-not-allowed opacity-60",
                    action.checked && !disabled && "border-teal bg-teal/10"
                  )}
                >
                  <Checkbox
                    ...
                    disabled={disabled}
                    className="data-[state=checked]:border-teal data-[state=checked]:bg-teal h-5 w-5 border-2"
                  />
                  <div
                    className={cn(
